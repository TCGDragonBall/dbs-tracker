...
playmats = playmats.split('`;')[0];
playmats += `PM-CEL19-01	Celebrations 2019 Playmat 1	Accessories	Playmat	Neutral	PM_CELEBRATIONS_2019	-	-	-	-	-	-	-	-
...
sleeves = sleeves.split('`;')[0];
sleeves += `SL-CEL19-01	Celebrations 2019 Sleeves	Accessories	Sleeve	Neutral	SL_CELEBRATIONS_2019	-	-	-	-	-	-	-	-
\`;
`;
